...
export default function ContactPage() {
      ...
      <div style={{ backgroundColor: "#c0c0c0", minHeight: "100vh", fontFamily: "Times New Roman, serif", padding: "20px" }}>
        ...
        <div style={{ maxWidth: "600px", margin: "60px auto 0", backgroundColor: "#fff", padding: "20px", border: "1px solid #808080" }}>
          ...
          <p style={{ fontSize: "12px", color: "#666", textAlign: "center" }}>
            You will receive a response from @quirkybytes.com within 24-48 hours.
          </p>
  ...
  // Default geocities-style contact
  return (
    <>
      <EraSlider />
      ...
      <main 
        style={{ 
          ...
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23000066' fill-opacity='0.4'%3E%3Cpath d='M20 20.5V1h1v19.5h18.5v1H21v18.5h-1V21.5H1v-1h19.5z'/%3E%3C/g%3E%3C/svg%3E")`,
        }}
      >
        <div style={{ maxWidth: "768px", margin: "0 auto", padding: "0 20px" }}>
            ...
            <div style={{ padding: "24px", backgroundColor: "#ffffcc" }}>
              {status === "sent" ? (
                <div style={{ textAlign: "center", padding: "40px" }}>
                  ...
                  <h2 style={{ fontFamily: "'Silkscreen', monospace", fontSize: "16px", color: "#00ff00", marginBottom: "16px" }}>
                    MESSAGE SENT!
                  </h2>
                  <p style={{ fontFamily: "'VT323', monospace", fontSize: "18px", marginBottom: "24px" }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                  {/* Name */}
                  <div>
                    <label style={{ fontFamily: "'Silkscreen', monospace", fontSize: "10px", color: "#000080", display: "block", marginBottom: "8px" }}>
                      YOUR NAME: *
                    </label>
                    <input
                      type="text"
                      ...
                      value={formData.name}
                      onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                      style={{ width: "100%", padding: "12px", fontFamily: "'VT323', monospace", fontSize: "18px", border: "2px solid #808080", backgroundColor: "#fff" }}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      value={formData.message}
                      onChange={(e) => setFormData({ ...formData, message: e.target.value })}
                      style={{ width: "100%", padding: "12px", fontFamily: "'VT323', monospace", fontSize: "18px", border: "2px solid #808080", backgroundColor: "#fff", resize: "none" }}
                  ...
                  {status === "error" && (
                    <p style={{ textAlign: "center", color: "#dc2626", fontFamily: "'VT323', monospace", marginTop: "16px" }}>
          ...
          <Window title="📬 WHAT_HAPPENS_NEXT.txt">
            <div style={{ padding: "24px", backgroundColor: "#c0c0c0", textAlign: "center" }}>
              <p style={{ fontFamily: "'VT323', monospace", fontSize: "18px", marginBottom: "8px" }}>
